                ...
                <div className="panels-container">
                    <div className="panel left-panel">
                        <div className="content">
                            ...
                            <p>
                                ...
                                personalizar o seu VR da forma de desejar. Esta
                                é uma empresa onde você consegue expressar sua
                    ...
                    <div className="panel right-panel">
                        <div className="content">
                            ...
                            <p>
                                É muito bom te ver aqui de novo, faça seu login
                                e veja as novidades que estão te esperando,
                                corre antes que acabem as promoções.
                            </p>
                            <button
                                className="buttn transparent"
                                id="sign-in-btn"
