            ...
            <div className="Descricao">
              ...
              <div id="Texto_descricao">
                <p className="Text_desc">
                  ...
                  áudio posicional 3D semelhante ao áudio de cinema.
                  Espelhamento diretamente para uma TV compatível ou para o
                  aplicativo Oculus para celular. Compatível com VR no PC usando
                  o Oculus Link, um cabo de fibra óptica de alta velocidade (não
                  incluido). Facilidade na configuração com o aplicativo Oculus
                  para celular.
                </p>
                ...
                <ul className="List_descrição">
                  ...
                  <li>
                    - Processador Qualcomm Snapdragon XR2 ultrarrápido com 6 GB
                    de RAM e 128GB de memória
                  </li>
                  <li>
                    - Dois controles Oculus Touch remodelados com rastreamento
                    das mãos de última geração.
                  </li>
                  <li>
