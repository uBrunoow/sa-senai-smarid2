          ...
          <div className="Links-sidebar">
            <ul>
              <li>
                ...
                <a href="/conta" className="Links">Minha conta</a>
              </li>
              <li>
                {" "}
                <BsFillPersonFill className="Link_icon" />
                <a href="" className="Links">Meus dados</a> 
              </li>
              <li>
                {" "}
                <IoBasketSharp className="Link_icon" />
                <a href="/hisorico"className="Links">Meus pedidos</a> 
              </li>
              <li>
                {" "}
                <AiFillHeart className="Link_icon" />
                <a href="/lista-de-desejos" className="Links">Favoritos</a> 
              </li>
              <li>
                {" "}
                <MdDiscount className="Link_icon" /> 
                <a href="" className="Links">Ofertas do dia</a> 
              </li>
              <li>
                {" "}
                <IoFlash className="Link_icon" /> 
                <a href="" className="Links">Acabaram de chegar</a> 
              </li>
              <li>
                {" "}
                <IoIosChatboxes className="Link_icon" /> 
                <a href="" className="Links">Protocolos de atendimento</a> 
              </li>
              <li>
                {" "}
                <AiFillLike className="Link_icon" /> 
                <a href="" className="Links">Avaliações</a>
              </li>
              <li>
                {" "}
                <AiOutlineAim className="Link_icon" />
                <a href="" className="Links">Mais Procurados</a> 
              </li>
            </ul>
